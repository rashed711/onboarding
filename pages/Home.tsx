...
import { ArrowRight, Users, ClipboardCheck, TrendingUp, ShieldCheck, Landmark, Globe, ExternalLink } from 'lucide-react';
    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen flex items-center pt-20 overflow-hidden bg-charcoal md:bg-white">
        ...
        <div className="absolute inset-0 z-0 lg:hidden overflow-hidden">
          ...
          />
          {/* Professional Overlay Gradients - Darker for better text contrast */}
          <div className="absolute inset-0 bg-gradient-to-t from-charcoal via-charcoal/80 to-charcoal/40"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10 w-full py-16 lg:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-500/20 lg:bg-red-50 text-[#E31E24] text-[10px] md:text-xs font-black uppercase tracking-widest mb-6 border border-red-500/30 lg:border-red-100 mx-auto lg:mx-0 backdrop-blur-md lg:backdrop-blur-none">
                <span className="flex h-2 w-2 rounded-full bg-[#E31E24] animate-pulse"></span>
                Middle East Strategic Leader
              </motion.div>
              
              <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white lg:text-gray-900 leading-[1.1] mb-6 md:mb-8 tracking-tight">
                We Fix <span className="text-[#E31E24]">What’s</span> Silently Killing Pharmacy Performance.
              </motion.h1>
              
              <motion.p variants={itemVariants} className="text-base md:text-xl text-gray-200 lg:text-gray-500 mb-8 md:mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0">
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center lg:justify-start">
                <Link
                  to="/contact"
                  className="bg-[#E31E24] text-white px-8 md:px-10 py-4 md:py-5 rounded-xl font-black text-center hover:bg-[#c41a1f] transition-all shadow-xl hover:shadow-2xl flex items-center justify-center gap-3 group text-sm md:text-base active:scale-[0.98]"
                >
                  Book Assessment
                ...
                <Link
                  to="/services"
                  className="bg-white/90 lg:bg-white/80 backdrop-blur-md border border-white/40 lg:border-gray-300 text-charcoal px-8 md:px-10 py-4 md:py-5 rounded-xl font-black text-center hover:bg-white hover:text-charcoal transition-all flex items-center justify-center gap-2 text-sm md:text-base active:scale-[0.98]"
                >
                  Practice Areas
                </Link>
              </motion.div>
      ...
      <section className="py-20 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link to="/services" className="inline-flex items-center gap-2 text-charcoal font-black text-xs md:text-sm pb-2 border-b-2 border-gray-200 hover:border-[#E31E24] hover:text-[#E31E24] transition-all mx-auto lg:mx-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
            {SERVICES.map((service, index) => (
              <motion.div 
                ...
                className="group bg-white p-8 md:p-10 rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col h-full active:scale-[0.99]"
              >
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                 <motion.div variants={itemVariants} className="bg-charcoal p-8 md:p-10 rounded-3xl text-white">
                    <p className="text-3xl md:text-5xl font-black mb-2 tracking-tighter">15+</p>
                    <p className="text-[9px] md:text-xs font-bold opacity-60 uppercase tracking-widest leading-tight">Years of Regional Experience</p>
                 </motion.div>
                 <motion.div variants={itemVariants} className="bg-gray-50 p-8 md:p-10 rounded-3xl text-charcoal border border-gray-100">
                    <p className="text-3xl md:text-5xl font-black mb-2 tracking-tighter">80%</p>
                    <p className="text-[9px] md:text-xs font-bold opacity-60 uppercase tracking-widest leading-tight">Market Retention Rate</p>
                 </motion.div>
                 <motion.div variants={itemVariants} className="sm:col-span-2 bg-red-50 p-8 md:p-10 rounded-3xl border border-red-100 relative overflow-hidden">
                    ...
                    <p className="text-sm md:text-lg font-bold text-charcoal mb-6 italic relative z-10 leading-relaxed">"Onboarding 4U provides the precise level of pharmaceutical domain expertise that generic firms lack."</p>
                    <div className="flex items-center gap-4 relative z-10">
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-red-200 border-2 border-white"></div>
                      <div>
                        <p className="font-black text-charcoal text-xs md:text-base leading-none mb-1">Dr. Tarek Hosney</p>
                        <p className="text-[8px] md:text-[10px] text-[#E31E24] font-black uppercase tracking-widest">COO, Gabr pharmacy chain</p>
                      </div>
                    </div>
                 </motion.div>
               </div>
            ...
            >
              ...
              <h3 className="text-2xl md:text-5xl font-black text-charcoal mb-10 leading-tight">Credibility Rooted in Specialist Knowledge</h3>
              <div className="space-y-8 md:space-y-10">
                {[
                  ...
                  <motion.div 
                    ...
                    className="flex flex-col sm:flex-row items-center lg:items-start gap-4 md:gap-6"
                  >
                    ...
                    <div className="text-center sm:text-left">
                      <h5 className="text-lg md:text-xl font-black mb-1.5 md:mb-2">{item.title}</h5>
      ...
      <section className="py-20 md:py-24 bg-charcoal relative overflow-hidden">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10 text-center"
        >
          <motion.h2 
            ...
            className="text-white text-xl md:text-4xl font-black mb-12 md:mb-16 uppercase tracking-tight"
          >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10 md:gap-12">
            {[
              ...
              >
                <span className="text-[#E31E24] text-3xl md:text-5xl font-black mb-1 md:mb-2 tracking-tighter">{stat.val}</span>
                <span className="text-gray-400 text-[9px] md:text-xs font-black uppercase tracking-[0.2em]">{stat.label}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <section className="py-20 md:py-32 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <h2 className="text-charcoal text-3xl md:text-6xl font-black mb-6 md:mb-8 leading-tight tracking-tight">Elevate Your Retail Performance Today.</h2>
            <p className="text-gray-500 text-base md:text-xl mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/contact"
                className="bg-[#E31E24] text-white px-8 md:px-12 py-4 md:py-5 rounded-xl font-black text-base md:text-lg hover:bg-charcoal transition-all shadow-2xl flex items-center justify-center gap-3 active:scale-[0.98]"
              >
                Request Portfolio Audit
                <ArrowRight size={20} />
              </Link>
            </div>
            <p className="mt-8 md:mt-12 text-gray-400 text-[9px] md:text-xs font-black uppercase tracking-[0.4em]">Cairo • Riyadh • Jeddah</p>
          </motion.div>
        </div>
      </section>
    </div>
